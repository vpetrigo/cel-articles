...
\begin{enumerate}
    ...
    \verb{http://meshconnect.cel.com/docs/default-source/brochures/cel_ethernet_gateway_pb.pdf?sfvrsn=4}, свободный
    \item EM35x Mini Modules: ZICM35xSP0 and ZICM35xSP2 / California Eastern Laboratories. -- 2015.– Режим доступа:
    \verb{http://meshconnect.cel.com/docs/default-source/data-sheets/em35x_mini_modules_ds.pdf?sfvrsn=17}, свободный
\end{enumerate}
\end{document}
