...
ZigBee-Ethernet-шлюзы являются полноценными участниками ZigBee-сети и позволяют как
обрабатывать входящие TCP/UDP/HTTP-сообщения, так и отправлять их по указанному 
во встроенном в шлюз приложении адресу.
